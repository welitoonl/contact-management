                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('contacts.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="contact" type="number" class="form-control @error('contact') is-invalid @enderror" maxlength="9" name="contact" value="{{ old('contact') }}" required autocomplete="contact">
